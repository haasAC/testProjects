...
public class BinarySearchTree<E extends Comparable<E>> extends AbstractTree<E> {
    ...
    public int getNumberOfLeaves(TreeNode<E> node) {
        int sum = 0;
        if (node.left != null) {
            sum += getNumberOfLeaves(node.left);
        }
        if (node.right != null) {
            sum += getNumberOfLeaves(node.right);
        }
	 ...
	 * elementÃ¢â‚¬â„¢s left sub-tree, returns an empty ArrayList if no such element
	 * exists.
     */
    ...
    /*
	 * Returns an ArrayList containing all elements in preorder of the specified
	 * elementÃ¢â‚¬â„¢s right sub-tree, returns an empty ArrayList if no such element
	 * exists.
     */
    ...
    public boolean sameTree(TreeNode tree1, TreeNode tree2) {
        ...
        if (tree1 != null && tree2 != null) {
            return (tree1.element == tree2.element && sameTree(tree1.left, tree2.left)
